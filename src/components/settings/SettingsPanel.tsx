...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="mb-3">
      <label className="text-[10px] block mb-1 tracking-wider" style={{ color: '#94a3b8', fontFamily: 'Rajdhani, sans-serif' }}>
        {label}
      </label>
      {children}
    </div>
...
export default function SettingsPanel() {
  ...
  return (
    <div className="flex flex-col flex-shrink-0 overflow-y-auto p-4"
      style={{ width: 260, background: 'rgba(5,7,10,0.5)' }}>

      <div className="text-xs font-bold tracking-widest mb-4" style={{ fontFamily: 'Rajdhani, sans-serif', color: '#a855f7', letterSpacing: '0.15em' }}>
      ...
      <div className="mb-4 pb-4" style={{ borderBottom: '1px solid rgba(124,58,237,0.15)' }}>
        ...
        <Field label="KONUŞMA HIZI">
          <input value={settings.voice.rate}
        ...
        <Field label="PİTCH">
          <input value={settings.voice.pitch}
      ...
      <div className="mb-4">
        ...
        <Field label="VARLIK KLASÖRÜ">
          <input value={settings.assetsPath}
